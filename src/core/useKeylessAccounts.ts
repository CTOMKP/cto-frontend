...
const storage = createJSONStorage<KeylessAccountsState>(() => localStorage, {
  replacer: (_, e) => {
    if (typeof e === "bigint") return { __type: "bigint", value: e.toString() } as BigIntEncoded;
    if (e instanceof Uint8Array)
      return { __type: "Uint8Array", value: Array.from(e) } as Uint8ArrayEncoded;
    if (e instanceof EphemeralKeyPair)
      return EphemeralKeyPairEncoding.encode(e);
    if (e instanceof KeylessAccount) return KeylessAccountEncoding.encode(e);
    return e;
  },
  reviver: (_, e: StorageValue) => {
    if (e && typeof e === "object" && "__type" in e) {
      switch (e.__type) {
        case "bigint":
          return BigInt((e as BigIntEncoded).value);
        case "Uint8Array":
          return new Uint8Array((e as Uint8ArrayEncoded).value);
        case "EphemeralKeyPair":
          return EphemeralKeyPairEncoding.decode(e as EphemeralKeyPairEncoded);
        case "KeylessAccount":
          return KeylessAccountEncoding.decode(e as KeylessAccountEncoded);
      }
    }
    return e;
  },
