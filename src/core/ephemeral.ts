...
import { EphemeralKeyPairEncoded } from "./storage-types";

export const EphemeralKeyPairEncoding = {
  decode: (e: EphemeralKeyPairEncoded) => EphemeralKeyPair.fromBytes(e.data),
  encode: (e: EphemeralKeyPair): EphemeralKeyPairEncoded => ({
