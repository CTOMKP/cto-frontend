      ...
      <div className='flex items-center justify-between mt-4 mb-2 p-2'>
        ...
        {!isHidden && (
          <div className='flex items-center gap-2'>
            <Button className='h-8 rounded-lg border-[0.2px] border-[#FFFFFF20]'><Image loading="lazy" src="/customise.svg" alt="customise" width={13.33} height={12} /> Customize</Button>
            <Button 
              onClick={toggleVisibility}
